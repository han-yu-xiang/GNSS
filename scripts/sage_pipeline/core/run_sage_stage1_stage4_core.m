function result = run_sage_stage1_stage4_core(windowCatalog, symbolCatalog, rawFile, outputDir, cfg)
%RUN_SAGE_STAGE1_STAGE4_CORE Shared Stage1-Stage4 execution and checkpoint orchestration.
% This function is the single Stage1-Stage4 implementation used by the
% production and Rain adapters. Its numerical functions are extracted
% without parameter changes from the validated production pipeline.
...
result = struct( ...
    "dopplerSignUsed", dopplerSignUsed, ...
    "stage1Table", stage1Table, ...
    "candidateIndices", candidateIndices, ...
    "stage2Fits", stage2Fits, ...
    "modelTable", modelTable, ...
    "selectedTable", selectedTable, ...
    "pathTable", pathTable, ...
    "persistenceTable", persistenceTable, ...
    "reliableTable", reliableTable, ...
    "jointFits", jointFits, ...
    "jointSummaryTable", jointSummaryTable, ...
    "jointPathTable", jointPathTable);
end
